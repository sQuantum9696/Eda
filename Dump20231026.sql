...
CREATE TABLE `Korzina` (
  ...
  KEY `fk_Korzina_1_idx` (`id_product`),
  CONSTRAINT `fk_Korzina_1` FOREIGN KEY (`id_product`) REFERENCES `Product` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Otzivi` (
  ...
  KEY `fk_Otzivi_1_idx` (`id_user`),
  CONSTRAINT `fk_Otzivi_1` FOREIGN KEY (`id_user`) REFERENCES `User` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Voice` (
  ...
  KEY `fk_Voice_2_idx` (`id_otzivi`),
  KEY `fk_Voice_3_idx` (`id_korzina`),
  KEY `fk_Voice_4_idx` (`id_product`),
  KEY `fk_Voice_5_idx` (`id_user`),
  CONSTRAINT `fk_Voice_1` FOREIGN KEY (`id_admin`) REFERENCES `Admin` (`id`),
  CONSTRAINT `fk_Voice_2` FOREIGN KEY (`id_otzivi`) REFERENCES `Otzivi` (`id`),
  CONSTRAINT `fk_Voice_3` FOREIGN KEY (`id_korzina`) REFERENCES `Korzina` (`id`),
  CONSTRAINT `fk_Voice_4` FOREIGN KEY (`id_product`) REFERENCES `Product` (`id`),
  CONSTRAINT `fk_Voice_5` FOREIGN KEY (`id_user`) REFERENCES `User` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-10-26 12:09:20
